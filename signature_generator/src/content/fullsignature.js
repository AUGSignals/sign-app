...
const FullSignature = (props) => {
    ...
    #xdc5f36aa2a894b73abd34b98610a73a6 a:link, #xdc5f36aa2a894b73abd34b98610a73a6 span.MsoHyperlink, #x5a37f54ea8964c03b9c8bbc2093ddeeb a:link, #x5a37f54ea8964c03b9c8bbc2093ddeeb span.MsoHyperlink
    ...
    return (
        <>
            <Row>
                ...
                <Col span={8}>
                    <Image className="auglogo" height="60px" src="https://augsignals.com/wp-content/uploads/logo/aug-logo-200x110.jpg"/>
                </Col>
                <Col span={8}>
                    <Image preview={false} className="airsencelogo" height="60px" src="https://augsignals.com/wp-content/uploads/logo/airsence-logo-234x130.png"/>
                </Col>
            </Row>
            <Row gutter={[8, 8]}>
                <Col span={8}>
